...
function esPrimo(numero) {
 ...
 for (let x= 2; x < numero /2 ; x++) {if (numero % x == 0)return false}
 return true;
}

function esVerdadero(valor){
  //Escribe una función que reciba un valor booleano y retorne “Soy verdadero” 
  //si su valor es true y “Soy falso” si su valor es false.cs
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí 
  Valor = []
  for (let x=0; x <=60; x=x+6) {
    Valor.push (x)
    if (x===60) {return Valor}
